...
const Home = () => {
  ...
  return (
    <Layout>
      ...
      <h1 className=' text-4xl md:text-6xl mt-10 container mx-auto text-center font-bold uppercase'> choose your <span className='text-secondary'>game</span> <br /> & start now !!!</h1>
